...
from simplefont.controls.glyphDialogs import AddComponentDialog, EditDialog
from simplefont.drawingTools.baseTool import BaseTool
from simplefont.tools import bezierMath, platformSpecific
from simplefont.tools.uiMethods import (
